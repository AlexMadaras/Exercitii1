...
public class SignUpLogin {
    ...
    public void verifySignupFromIsVisible(){
    ...
    public void verifySignUpIsPresent(){
    ...
    public void completeInfoSignUp(int gender, String password, int day_of_birth, int month_of_birth, String year_of_birth){
        selectGender(gender);
